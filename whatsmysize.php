...
<head>
    ...
    <title>What’s My Size? | Help | QUINTET India </title>
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p style="margin-top: 30px;margin-bottom:20px;">
                            At Quintet, we offer a wide range of sizes that can vary according to the style, cut
                            and
                            fabric
                            of each garment. So that you can select the size that best suits you, you have two tools at
                            your disposal, our measurement guide and the Find your size option.

                        </p>

                        <h6>MEASUREMENT GUIDE</h6>
                        <p>
                            You can find our measurement guide on the product page. Select the size you are interested
                            in and we will show you what body measurements it fits.
                        </p>
                    </div>
                    <div class="RegisterAndLoginRighttext">
                    ...
                    <div class="accordion">
                        <div class="accordion-content">
                            <header>
                                <span class="title">HOW CAN I DETERMINE THE MEASUREMENTS OF AN ITEM?</span>
                                <i class="fa-solid fa-plus"></i>
                            </header>
                            <div class="description">
                                <div class="small_topicBox mobileview">
                                    If you want to know the measurements of any item, you can check our measurement
                                    guide. If you can't find the size you need, please contact us so we can help you.
                                </div>
                            </div>
                        </div>
                    </div>
