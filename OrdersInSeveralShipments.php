...
<head>
    ...
    <title>Orders In Several Shipments | Help | QUINTET India </title>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    <div class="RegisterAndLoginRighttext">
                        <h1>ORDERS IN SEVERAL SHIPMENTS</h1>
                    </div>
                    <div class="RegisterAndLoginRighttext">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p>
                            Sometimes we will offer to send your order items in multiple deliveries, depending on their
                            availability, so that you receive them as soon as possible.
                        </p>
                        <p>
                            When selecting the shipping method, we will show you the different options available for
                            each delivery, as well as the additional costs, so that you can choose whichever one is most
                            convenient.
                        </p>
                        <div class="RegisterAndLoginRighttext"
