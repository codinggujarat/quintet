<div class="RegisterAndLogin">
    <ul>
        <button>MY QUINTET ACCOUNT</button>
        <button class="active"><a href="registrationandlogin">REGISTRATION AND LOG IN</a></button>
        <button><a href="profilemanagement">MANAGING MY PROFILE</a></button>
        <button><a href="myfavourites">MY FAVOURITES</a></button>
    </ul>
