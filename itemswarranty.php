...
<head>
    ...
    <title>Items Warranty | Help | QUINTET India </title>
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p style="margin-top: 30px;margin-bottom:20px;">
                            All our articles follow strict <span>quality controls</span> so that you receive them and
                            enjoy them in
                            the best conditions.

                        </p>
                        <p>
                            However, if you have received a <span>faulty item </span> in your <span>order</span> , or if
                            after using
                            it, you detect
                            a defect, please contact us or visit a Zara store so that we can help you.
                        </p>
                        <p>
                            If the item was purchased in a <span>physical store </span>, please visit one of our stores
                            so that our
                            staff can assess it.
                        </p>
