...
<head>
    ...
    <title>Gift Packaging | Help | QUINTET India </title>
        ...
        <div class="" style="  padding: 0;margin-left:50px;margin-right:50px;  ">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p>
                            We offer you the possibility to add a <span>gift box</span> to your order. We will show you
                            this option
                            and the corresponding amount during the purchase process, after adding the items to your
                            basket.
                        </p>
                        <p>
                            We will prepare your order in a special box which will be sent in the usual packaging for
                            our orders.
                        </p>
                        <p>
                            Keep in mind that the boxes <span>not eligible for exchanges or returns</span>.
                        </p>
                        <p>
                            This option is only available for online purchases. If you wish to prepare items purchased
                            in a physical store as gifts, our staff will help you to package them in gift envelopes.
                        </p>
                    </div>
