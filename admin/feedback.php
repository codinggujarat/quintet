                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table   " data-toggle="data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    // Fetch chatbot data
                                                    $result = mysqli_query($con, "SELECT id, name, email, rating, comments, submitted_at FROM feedback ORDER BY submitted_at DESC");
                                                        ...
                                                        <td>
                                                            <div style="float:right;">
                                                                ...
                                                                <a class="btn btn-sm btn-icon text-black"
                                                                    ...
                                                                    href="feedback.php?delete_id=<?php echo $row['id']; ?>"
