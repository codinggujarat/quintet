                                        ...
                                        <tr>
                                            ...
                                            <td style="display: block;align-items: center;justify-content: center;
                                                ...
                                                <a href="updateorder.php?oid=<?php echo htmlentities($row['id']); ?>"
                                                    ...
                                                    style="display: flex;align-items: center;justify-content: center;   height: 50px; border: 1px solid black ; padding: 10px;height: 20px;width: 20px;border-radius: 50px; "><i
                                                        class='bx bxs-edit' style="font-size: 20px; color: black; "></i>
                                                </a>
                                            </td>
                                        </tr>
