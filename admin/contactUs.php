                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table   " data-toggle="data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    // Fetch chatbot data
                                                    $result = mysqli_query($con, "SELECT * FROM contact_us ORDER BY submission_date DESC");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="<?php echo htmlspecialchars($row['website_url']); ?>"><?php echo htmlspecialchars($row['website_url']); ?></a>
                                                        </td>
