...
<head>
    ...
    <title>Admin| Dispatched Orders</title>
                        ...
                        <div class="card p-0">
                            <div class="card-body">
                                <h3 style="font-size: 17px; font-family: ' Poppins',sans-serif ;font-weight: 400 !important ; "
                                    class=" text-uppercase">Dispatched Orders
                                                            ...
                                                            <td>
                                                                <div style="float:right;">
                                                                    <a class="btn btn-sm btn-icon text-black flex-end"
                                                                        data-bs-toggle="tooltip" title="Manage Order"
                                                                        href="order-details.php?oid=<?php echo htmlentities($row['id']); ?>">
