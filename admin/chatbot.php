            ...
            <div class="coner-fc content-inner mt-5 py-0 ">
                <div class="row" style=" margin-top: 100px !important;">
                    <div class="col-sm-12">
                        ...
                        <a href="chatbot-insert.php" class="p-2 m-2 btn btn-dark">INSERT QUERY</a>
                        <div class="card ">
                                                        ...
                                                        <td class="actions">
                                                            <div style="float:right;">
                                                                <a class="btn btn-sm btn-icon text-black flex-end"
                                                                    data-bs-toggle="tooltip" title="Edit Query"
                                                                    href="chatbot-update.php?id=<?php echo $row['id']; ?>">
                                                                ...
                                                                <a class="btn btn-sm btn-icon text-black"
                                                                    data-bs-toggle="tooltip" title="Delete Query"
                                                                    href="chatbot-delete.php?id=<?php echo $row['id']; ?>"
