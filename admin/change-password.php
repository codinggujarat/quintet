                ...
                <div class="conatiner-fluid content-inner mt-5 py-0 d-flex align-items-center justify-content-center">
                    <div class="module bg-white p-5 rounded-3"
                        ...
                        <div class="module-head">
                            <h6 class="text-uppercase " style="font-weight: 500;font-family: 'Raleway',sans-serif  ;  ">
                                Admin Change
                                Password
                            </h6>
                        </div>
                        <div class="module-body ">
                            ...
                            <form class="form-horizontal row-fluid " name="chngpwd" method="post"
                                ...
                                <div class="control-group mb-3">
                                    <label class="control-label text-capitalize  text-black  " for="basicinput"
                                        style="font-size: 14px;font-weight: 500; ">Enter Your Current
                                        Password</label>
                                    <input type="password" placeholder="Enter your current Password" name="password"
                                        class="bg-transparent border-1 rounded-0 w-100 p-lg-2" required
                                ...
                                <div class="control-group mb-3">
                                    <label class="control-label text-capitalize  text-black" for="basicinput"
                                        style="font-size: 14px;font-weight: 500; ">Enter Your New
                                        Password</label>
                                    <input type="password" placeholder="Enter your new current Password " name="newpassword"
                                        class="bg-transparent border-1 rounded-0 w-100 p-lg-2" required
                                        style="outline: 0  !important ;border: 1px solid black; ">
                                </div>
                                ...
                                <div class="control-group mb-3">
                                    ...
                                    <input type="password" placeholder="Enter your new Password again"
                                        name="confirmpassword" class="bg-transparent border-1 rounded-0 w-100   p-lg-2  "
                                ...
                                <div class="control-group">
                                    <button type="submit" name="submit"
                                        class="btn col-lg-12 bg-black text-white text-uppercase  border-0 rounded-0"
                                        style=" font-family: 'Raleway' ,sans-serif ; font-weight: 400 !important ;  ">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
