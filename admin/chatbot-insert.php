...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['insert'])) {
        ...
        if (mysqli_query($con, $sql)) {
            header("Location: chatbot-insert.php");
        } else {
...
<head>
    ...
    $(document).ready(function() {
        tinymce.init({
            ...
            images_upload_url: 'chatbot-insert.php', // Create this file for handling image uploads
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-control">
                                                <button type="submit" class="btn btn-dark text-uppercase"
                                                    name="insert">UPDATE</button>
                                                <a href="chatbot.php" class="btn btn-dark text-uppercase">Back to
                                                    List</a>
                                            </div>
                                        </form>
                                    </div>
