    ...
    if (strlen($_SESSION['alogin']) == 0) {
        ...
        if (isset($_POST['submit'])) {
            ...
            move_uploaded_file($_FILES["productimageFour"]["tmp_name"], "productimages/$pid/" . $_FILES["productimageFour"]["name"]);
            $sql = mysqli_query($con, "update  products set productImageFour='$productimageFour' where id='$pid' ");
                                        ...
                                        <div class="module-body">
                                            ...
                                            <div class="alert alert-success">
                                                ...
                                                <button type="button" class="close" data-dismiss="alert">
                                                    <svg fill="#000000" height="12px" width="12px" version="1.1"
                                            ...
                                            <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                                                ...
                                                <?php
                                                    ...
                                                    $query = mysqli_query($con, "select productName,productImageFour from products where id='$pid'");
                                                    $cnt = 1;
                                                ...
                                                <div class="control-group mb-3" style="position: relative;">
                                                    <input type="file" name="productimageFour" id="productimageFour"
                                                        value=""
                                                        class="bg-transparent border-1 rounded-0 w-100 p-lg-2 text-black"
                                                        required
                                                        style="outline: 0  !important ;border: 1px solid black; ">
                                                    <label class="imgLable">New
                                                        Product Image Four</label>
                                                </div>
