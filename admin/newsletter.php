...
<head>
    ...
    <title>Manage - Newsletter Subscribers</title>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table   " data-toggle="data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    // Fetch chatbot data
                                                    $result = mysqli_query($con, "SELECT id, email, subscription_date FROM newsletter_subscribers ORDER BY subscription_date DESC");
                                                        ...
                                                        <td>
                                                            <div style="float:right;">
                                                                ...
                                                                <a class="btn btn-sm btn-icon text-black"
                                                                    data-bs-toggle="tooltip" title="Delete Subscribers"
                                                                    href="delete_subscriber.php?id=<?php echo $row['id']; ?>"
                                                                    class="delete-btn"
