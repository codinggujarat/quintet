...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file($_FILES["productimageFive"]["tmp_name"], "productimages/$pid/" . $_FILES["productimageFive"]["name"]);
        $sql = mysqli_query($con, "update  products set productImageFive='$productimageFive' where id='$pid' ");
                                    ...
                                    <div class="module-body">
                                        ...
                                        <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                                            ...
                                            <?php
                                                ...
                                                $query = mysqli_query($con, "select productName,productImageFive from products where id='$pid'");
                                                $cnt = 1;
                                            ...
                                            <div class="control-group mb-3" style="position: relative;">
                                                ...
                                                <labeld class="imgLable">Current
                                                    Product Image Five</label>
                                            </div>



                                            <div class="control-group mb-3" style="position: relative;">
                                                <input type="file" name="productimageFive" id="productimageFive"
                                                    value=""
                                                    class="bg-transparent border-1 rounded-0 w-100 p-lg-2 text-black"
                                                    required style="outline: 0  !important ;border: 1px solid black; ">
                                                <labeld class="imgLable">New Product
                                                    Image Five</label>
                                            </div>
