...
<head>
    ...
    <title>Gift Card | Help | QUINTET India </title>
        ...
        <div class="" style="  padding: 0;margin-left:50px;margin-right:50px;  ">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-5">
                    <?php include('includes/giftoptions.php'); ?>
                </div>
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p>
                            Our Gift Card is the perfect choice for any occasion. Here's everything you need to know
                            about it.
                        </p>
                        <h6>FEATURES OF A GIFT CARD
                        </h6>
                        <ol class="list">
                            <li>You can use it online or in any of our Quintet stores.</li>
                            <li>It is valid only in the market/region in which it was purchased.</li>
                            <li>It is valid for one year.</li>
                            <li>It is a bearer document. Quintet will not replace the Gift Card if it is stolen, lost or
                                damaged.</li>
                            <li>Once purchased, the Gift Card cannot be returned.</li>
                        </ol>
                        <p>
                    ...
                    <div class="accordion">
                        <div class="accordion-content">
                            <header>
                                <span class="title">CAN I CHANGE THE VIRTUAL GIFT CARD RECIPIENT'S EMAIL ADDRESS?</span>
                                <i class="fa-solid fa-plus"></i>
                            </header>
                            <div class="description">

                                <div class="small_topicBox mobileview">
                                    If you have entered the wrong email address for the recipient of the Virtual Gift
                                    Card and you need to change it, you can contact us and we will help you.
                        ...
                        <div class="accordion-content">
                            <header>
                                <span class="title">CAN I CHANGE THE DATE OR TIME FOR SENDING THE VIRTUAL GIFT CARD?
                                </span>
                                <i class="fa-solid fa-plus"></i>
                            </header>
                            <div class="description">
                                <div class="small_topicBox mobileview">
                                    <p>
                                        Please note that we may change the date or time the Virtual Gift Card is sent if
                                        it has not yet been delivered. Please contact us so we can help you.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-content">
                            <header>
                                <span class="title">CAN I TOP UP A GIFT CARD?
                            ...
                            <div class="description">
                                <div class="small_topicBox mobileview">
                                    <p>
                                        Once your Gift Card has been used up, it cannot be topped up, but you can buy a
                                        new one if you wish.
                                </div>
                            </div>
                        </div>
