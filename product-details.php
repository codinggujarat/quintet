            ...
            <div class=" ">
                <div>
                    ...
                    <ul class="list-inline list-unstyled"
                        ...
                        <li style="padding: 0 !important ;margin: 0 !important  ; border: 0 !important  ; ">
                            <a href="index.php"
                                style="  border: 0 !important  ; font-size: 10px !important ; color: #000 !important ;font-family: 'Poppins', sans-serif !important;font-weight: 400 !important; ">Home
                                /</a>
                        </li>
                        <li style="padding: 0 !important ;margin: 0 !important  ; border: 0 !important  ; ">
                            <a href=""
                                style="  border: 0 !important  ; font-size: 10px !important ; color: #000 !important ;font-family: 'Poppins', sans-serif !important;font-weight: 400 !important;margin-left:10px; "><?php echo htmlentities($rw['catname']); ?>
                                /</a>
                        </li>
                        <li style="padding: 0 !important ;margin: 0 !important  ; border: 0 !important  ; ">
                            <a href=""
                                style="  border: 0 !important  ; font-size: 10px !important ; color: #000 !important ;font-family: 'Poppins', sans-serif !important;font-weight: 400 !important;margin-left:10px; "><?php echo htmlentities($rw['subcatname']); ?>
                                /</a>
                        </li>
                        <li class='active'
                            style="padding: 0 !important ;margin: 0 !important  ; border: 0 !important  ; ">
                            <a href=""
                                style="  border: 0 !important  ; font-size: 10px !important ; color: #000 !important ;font-family: 'Poppins', sans-serif !important;font-weight: 400 !important;margin-left:10px; "><?php echo htmlentities($rw['pname']); ?>
                            </a>
                        </li>
                        </li>
                    </ul>
        ...
        <div>
            <div class='row single-product outer-bottom-sm '>
                ...
                <div class='col-md-12'>
                    ...
                    <div class="row">
                        <div class=" col-xs-12 col-sm-12 col-md-4 desktopDiscription"
                            style="position: relative !important;display:flex;justify-content: center !important;padding-left:10%; align-items: center !important; ">
                            <div class="col-xs-12 col-sm-12 col-md-4 gallery-holder productDescription2">
                                ...
                                <div class="price-container info-container"
                                    ...
                                    <div style="width: 100%; display: flex;">
                                        ...
                                        <a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>"
                                            class="btn "
                                            style="text-transform: uppercase;font-weight: 500;   border-radius: 0 !important ;padding: 10px 20px; font-size: 12 !important ;display: flex;align-items: center;justify-content: center;  background: #000 !important ;   font-family: 'Poppins', sans-serif !important;font-weight: 400 !important; font-size: 12px !important ; color:#fff !important;   width: 80% !important ;  height: 40px !important ;border:0;border-top:1px solid black;  ">
                                            ADD </a>
                                        <?php } else { ?>
                                        ...
                                        <a class="btn" title="favourites"
                                            style="text-transform: uppercase;font-weight: 500;   border-radius: 0 !important ;padding: 10px 20px; font-size: 12 !important ;display: flex;align-items: center;justify-content: center;  background:transparent !important ;   font-family: 'Poppins', sans-serif !important;font-weight: 400 !important; font-size: 12px !important ; color:#fff !important;   width: 20% !important ;  height: 40px !important ;border:1px solid black;border:0;border-top:1px solid black;border-left: 1px solid black; "
                                            href="
                ...
                <div id="review" class="tab-pane in active">
                    ...
                    <div class="product-tab">
                        ...
                        <form role="form" class="cnt-form reviewForm" name="review" method="post"
                            ...
                            <div class="product-add-review" style="background: transparent;     border: 0 !important ;">
                                <style>
                                .rating1,
                                .rating2,
                                .rating3 {
                                ...
                                <div class="table-responsive" style="background:transparent;">
                                    <h4 class=" title "
                                        style="text-align: left; font-weight:400; text-transform:uppercase;font-family: 'Poppins', sans-serif !important;font-weight: 400 !important;font-size:20px;color: #000; ">
                                    ...
                                    <div class="row m-t-20">
                                        ...
                                        <div class="col-md-6 col-lg-12">
                                            <div class="form-group input-field-login col-lg-12">
                                                ...
                                                <textarea class="form-control txt txt-review input-field-login-textarea"
