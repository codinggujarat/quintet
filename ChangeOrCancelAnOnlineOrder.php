...
<head>
    ...
    <title>Change Or Cancel An Online Order | Help | QUINTET India </title>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    <div class="RegisterAndLoginRighttext">
                        <h1>Change Or Cancel An Online Order</h1>
                    </div>
                    <div class="RegisterAndLoginRighttext">
                        <img src="img/lookformyaccoutsidebar.jpg" alt="">
                    </div>
                    <div class="RegisterAndLoginRighttext">
                        <p>If you have placed your order and wish to modify it, here are the answers to the questions
                            you might have.
                        </p>
                        <h6>Can you cancel your order?
                        </h6>
                        <p>
                            It is possible to cancel a purchase as long as the order status allows it. If available, you
                            will see this option in your Quintet account, in the order details.
                        </p>
                        <h6>Can you change the delivery address of your order?
                        </h6>
                        <p>If you are a registered user and have chosen home delivery, you can change the delivery
                            address of your order, as long as your order status allows it. You can do this by accessing
                            the order details on your account.
                        </p>
                        <h6>
                        ...
                        <p>
                            If you have already completed your purchase, it is not possible to delete or change items.
                            If you wish, once you receive your order, you can manage a return.
                        </p>
