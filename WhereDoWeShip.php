...
<head>
    ...
    <title>Where Do We Ship? | Help | QUINTET India </title>
        ...
        <div class="" style="  padding: 0;margin-left:50px;margin-right:50px;  ">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p>
                            At Quintetonline.in, we try to reach every destination. If there are any shipping
                            restrictions on
                            your address, you will see them when you complete your order.
                        </p>
                        <p>
                            Please note that if your order includes a bulky item, neither the store shipping nor drop
                            point options will be available.
                        </p>
