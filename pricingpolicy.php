...
<head>
    ...
    <title>Pricing Policy | Help | QUINTET India </title>
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p style="margin-top: 30px;margin-bottom:20px;">
                            Quintet reserves the right to change the prices of items throughout the campaign.


                        </p>
                        <p>
                            All our items are <span>priced the same</span> online and in store. If there is any
                            <span>difference between the prices</span> shown on the website and on the labels, the
                            correct price will always be the
                            price shown at the time of purchase.
                        </p>
                        <p>
                            Please keep in mind we do not <span>adjust prices</span> for items whose original prices may
                            have been
                            reduced.
                        </p>
