...
<head>
    ...
    <title>Order Status | Help | QUINTET India </title>
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p style="margin-top: 30px;margin-bottom:20px;">
                            You can <span>track</span> your order in your account, on the <a
                                href="my-account.php">Purchases</a>
                            section. If
                            you are
                            not
                            registered, you will have this information by accessing the link that appears in any of the
                            emails we sent you about your order.
                        </p>
                        <p>
                        ...
                        <ol>
                            <li><span>Bought</span>: your order has been placed successfully.</li>
                            <li><span>Being processed</span>: we’ve received your order details.</li>
                            <li><span>Being prepared</span>: your order is being prepared in our warehouse.</li>
                            <li><span>Sent</span>: your order has already left our premises.</li>
                            <li><span>Collected by courier</span>: your order is on its way and will be delivered soon.
                            </li>
                            <li><span>Delivered to customer</span>: your order has been delivered.</li>
                        </ol>
                        <p>Bear in mind you will receive updates on the status of your order by email.
                        </p>
                    </div>
                        ...
                        <div class="accordion-content">
                            ...
                            <div class="description">
                                <div class="small_topicBox mobileview">
                                    <p>
                                        When placing the order, we will provide you with the estimated delivery date.
                                        Then you can track it from your <a href="my-account.php">account</a>
                                    </p>
                                </div>
                            </div>
                        </div>
