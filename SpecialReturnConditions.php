...
<head>
    ...
    <title>Special Return Conditions | Help | QUINTET India </title>
        ...
        <div class="" style="  padding: 0;margin-left:50px;margin-right:50px;  ">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7">
                    ...
                    <div class="RegisterAndLoginRighttext">
                        <p>
                            Due to their special characteristics, some of our items must fulfil the following criteria
                            to be returned or exchanged:

                        </p>

                        <ol>
                            <li><span>Swimwear & Swimsuit:</span> will not be able to return.</li>
                            <li><span>Accessories: </span>gloves, scarf, hairband, turban, hat, belt, bracelets, bow
                                tie, sunglasses,
                                sock, jewellery, umbrella, stocking, tights, bodysuits, etc. will not be able to return.
                            </li>
                            <li><span>Fragrances:</span> will not be able to return.</li>
                            <li><span>Watches:</span> will not be able to return.</li>
                            <li><span>Cosmetics: </span>will not be able to return.</li>
                            <li><span>Special packaging and additional accessories:</span> items with special packaging
                                (fabric bags,
                                special boxes, etc.) or additional accessories must be returned with said packaging or
                                accessories in the same condition.</li>
                            <li><span>Spalding Ball:</span> ineligible for exchange or return.</li>
                        </ol>
